// Exercise Database - CommonJS module
// ExerciseData interface: { id, name, category, muscleGroups, equipment, difficulty, description, instructions, tips?, imageUrl?, videoUrl? }
...
const getRandomExercises = (count, filters) => {
